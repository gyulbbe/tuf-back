...
//                .anyRequest().authenticated());
        ...
        http.authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/tournaments/*/race-survival-progress-submissions/*/approve").hasAnyRole("MANAGER", "MASTER", "ADMIN")
                .requestMatchers(HttpMethod.POST, "/tournaments/*/race-survival-progress-submissions/*/reject").hasAnyRole("MANAGER", "MASTER", "ADMIN")
                .requestMatchers(HttpMethod.POST, "/tournaments/*/race-survival-progress-submissions").authenticated()
                .requestMatchers(HttpMethod.GET, "/tournaments/*/race-survival-progress-submissions").authenticated()
